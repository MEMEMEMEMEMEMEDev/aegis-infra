...
- **Un verificador.** 250 checks estáticos miden este repositorio sin
...
flowchart LR
    subgraph P["el producto: este repositorio, solo lectura durante una corrida"]
        ...
        p3["verify/<br/>250 checks y sus dientes"]
...
![Salidas reales: aegis init --list con las dieciséis fases pasadas y aegis verify con 250 checks en verde en los dos perfiles](docs/assets/terminal.svg)
