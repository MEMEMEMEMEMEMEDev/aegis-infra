...
rojo_1() { rm -f "$AEGIS_ROOT/semilla/plataforma/docs/protocols/templates/Jenkinsfile.app"; }

# control: un cambio LEGÍTIMO no puede ponerlo rojo
control_1() { printf '# comentario legitimo\n' >> "$AEGIS_ROOT/semilla/plataforma/docs/protocols/templates/Jenkinsfile.app"; }
