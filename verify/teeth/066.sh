# teeth for check 066 — generated on 2026-08-23 and VERIFIED:
...
red_1() {
    grep -vE 'secretName.*registry-tls' "$AEGIS_ROOT/init/phases/40-registry-pki.sh" > "$AEGIS_ROOT/init/phases/40-registry-pki.sh.tooth" \
