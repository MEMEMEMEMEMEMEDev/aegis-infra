# teeth for check 079 — generated on 2026-08-23 and VERIFIED:
...
red_1() {
    grep -vE 'for i in |until curl' "$AEGIS_ROOT/init/phases/80-supply-chain.sh" > "$AEGIS_ROOT/init/phases/80-supply-chain.sh.tooth" \
