# teeth of check 037 — generated on 2026-08-23 and VERIFIED: every red
...
red_1() {
    grep -vE 'store_rc_guard' "$AEGIS_ROOT/init/phases/80-supply-chain.sh" > "$AEGIS_ROOT/init/phases/80-supply-chain.sh.tooth" \
