# teeth for check 053 — generated on 2026-08-23 and VERIFIED:
...
red_1() {
    grep -vE 'gate "firma-verificada-real"' "$AEGIS_ROOT/init/phases/80-supply-chain.sh" > "$AEGIS_ROOT/init/phases/80-supply-chain.sh.tooth" \
