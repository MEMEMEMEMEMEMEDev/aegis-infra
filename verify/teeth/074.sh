# dientes del check 074 — generados el 2026-08-23 y VERIFICADOS:
# cada rojo se aplicó sobre una copia del árbol y el check se puso rojo.

# saca del artefacto justo lo que el check dice medir
rojo_1() {
    grep -vE 'spec.syncPolicy.syncOptions' "$AEGIS_ROOT/lib/common.sh" > "$AEGIS_ROOT/lib/common.sh.diente" \
