# teeth for check 090 — generated on 2026-08-23 and VERIFIED:
...
red_1() {
    grep -vE 'cloudflareaccess\.com' "$AEGIS_ROOT/lib/access.sh" > "$AEGIS_ROOT/lib/access.sh.tooth" \
        && mv "$AEGIS_ROOT/lib/access.sh.tooth" "$AEGIS_ROOT/lib/access.sh"
}
