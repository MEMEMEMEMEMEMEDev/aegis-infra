# teeth for check 056 — generated on 2026-08-23 and VERIFIED:
...
red_1() {
    grep -vE 'kubectl kustomize.*kyverno-policies' "$AEGIS_ROOT/init/phases/80-supply-chain.sh" > "$AEGIS_ROOT/init/phases/80-supply-chain.sh.tooth" \
