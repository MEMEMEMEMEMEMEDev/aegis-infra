# teeth for check 067 — generated on 2026-08-23 and VERIFIED:
...
red_1() {
    grep -vE 'wait_rollout jenkins-system sts/jenkins' "$AEGIS_ROOT/init/phases/50-jenkins.sh" > "$AEGIS_ROOT/init/phases/50-jenkins.sh.tooth" \
