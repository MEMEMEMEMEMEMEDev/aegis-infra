# teeth for check 075 — generated on 2026-08-23 and VERIFIED:
...
red_1() {
    grep -vE 'trap '\''secrets_cleanup; exit 130'\'' INT TERM' "$AEGIS_ROOT/lib/secrets.sh" > "$AEGIS_ROOT/lib/secrets.sh.tooth" \
