# teeth for check 083 — generated on 2026-08-23 and VERIFIED:
...
red_1() {
    grep -vE 'AEGIS_VALIDATE_FAILCLOSED' "$AEGIS_ROOT/init/phases/80-supply-chain.sh" > "$AEGIS_ROOT/init/phases/80-supply-chain.sh.tooth" \
