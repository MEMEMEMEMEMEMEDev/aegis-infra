# teeth for check 068 — generated on 2026-08-23 and VERIFIED:
...
red_1() {
    grep -vE 'CA_INJECTED_THIS_RUN' "$AEGIS_ROOT/init/phases/80-supply-chain.sh" > "$AEGIS_ROOT/init/phases/80-supply-chain.sh.tooth" \
