        ...
        container('node') {
          withCredentials([usernamePassword(
            ...
            sh '''
              ...
              node ci/escribir-digest.mjs "${REGISTRY}/${IMAGE}=${DIGEST}"
      ...
      steps {
        sh '''
          ...
          printf '%s\n' "$EVENTO" \
            ...
            || echo 'AVISO: el evento no se pudo registrar en vlogs-eventos (el build NO falla por esto)'
