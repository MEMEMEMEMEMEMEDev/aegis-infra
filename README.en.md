...
- **A verifier.** 250 static checks measure this repository without a
...
flowchart LR
    subgraph P["the product: this repository, read-only during a run"]
        ...
        p3["verify/<br/>251 checks and their teeth"]
...
![Real outputs: aegis init --list with all sixteen phases passed, and aegis verify with 251 checks green in both profiles](docs/assets/terminal.en.svg)
