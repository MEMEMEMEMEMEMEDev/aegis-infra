...
- **A verifier.** 241 static checks measure this repository without a
...
flowchart LR
    subgraph P["the product: this repository, read-only during a run"]
        ...
        p3["verify/<br/>241 checks and their teeth"]
...
![Real outputs: aegis init --list with all sixteen phases passed, and aegis verify with 241 checks green in both profiles](docs/assets/terminal.en.svg)
